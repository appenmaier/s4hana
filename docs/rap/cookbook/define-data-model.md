...
Zum Speichern der Reise- und Buchungsdaten müssen zunächst entsprechende Datenbanktabellen erstellt werden. Anschließend werden darauf aufbauend dazugehörige Interface Views erstellt.
